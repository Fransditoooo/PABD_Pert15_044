...
namespace CRUDMahasiswaADO
{
    public partial class Form4 : Form
    {
        ...
        // String koneksi disesuaikan dengan Windows Authentication server Anda
        ...
        {
            // Mengirimkan nilai terpilh dari ComboBox dan DateTimePicker ke Form5
            Form5 frm2 = new Form5(cmbProdi.SelectedValue.ToString(), dtpTanggalMasuk.Value);
            frm2.Show();
            this.Hide();
        }
    }
